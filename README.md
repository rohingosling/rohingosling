...
📄 [**VJE** *(**V**ersatile **J**SON **E**ditor)*](https://github.com/rohingosling/vja) - Edit JSON files, with data capture forms and tables. ⛏️<br>
...
💳 [Exponentially Biased Debt Repayment Weight](https://github.com/rohingosling/exponentially-biased-debt-repayment-weight) [🌐](https://rohingosling.github.io/exponentially-biased-debt-repayment-weight/app/) - Rank repayment behavior with exponential decay.<br>
