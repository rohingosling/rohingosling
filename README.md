...
🌍 **UAE - Dubai** | 🤖 **Progenitor of Adaptive Systems** | 👽 **Aficionado of transhumanist philosophy** | 🛩️ **Extreme sports athlete**
...
🏛️ [**ECA Rule Engine Lab**](https://github.com/rohingosling/eca-rule-engine-2) - A domain independent, stateless, ECA (**E**vent **C**ondition **A**ction) rule engine. [🌐](https://rohingosling.github.io/eca-rule-engine-2/) ⛏️<br>
...
🎮 [ECS Game Engine ( Java Port from C++)](https://github.com/rohingosling/ecs-game-engine-java) - ECS (**E**ntity **C**omponent **S**ystem) Game Engine - Java version.<br>
...
🖥️ [**Data Probe**](https://github.com/rohingosling/data-probe) - HEX editor for MS-DOS.<br>
...
💵 [**APX Payment Manager**](https://github.com/rohingosling/apx-payment-manager) - Schedule disbursement payments from investment portfolios managed with [Advent APX](https://www.advent.com/solutions/advent-portfolio-exchange/).
...
- Former gymnast.
  - Gymnastics coach.
  - National gymnastic judge.
- Former freestyle BMX flatland show rider. Still ride a bit here and there.
- Former professional unicyclist. <i>...Easy progression, since we ride two-wheeled flatland bikes on one wheel anyway.</i> 
- Former trapeze artist.

- Former movie stunt man.
