...
- 📖 [Year Planner](https://github.com/rohingosling/year-planner) - Generate a printable **Year Planner** as `.docx` or `.pdf`, optimized for duplex printing. *Pregenerated PDFs --> [2026](), [2027]()*.
