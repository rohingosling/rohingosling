...
- 📖 [Year Planner](https://github.com/rohingosling/year-planner) - Generate a printable **Year Planner** as a `.docx` or `.pdf`, optimized for duplex printing. Pregenerated PDFs --> [2026](), [2027]().
